  ...
  return(
    <View style={tailwind('w-full h-full')}>
      ...
      <View style={[tailwind('w-full h-full absolute px-8 items-center'), {paddingTop: 350}]}>
        {/**<Text style={[tailwind(`text-white`), { fontSize: 25, fontFamily: "GmarketBold", lineHeight: 35 }]}>WELCOME TO <View style={tailwind("rounded-full bg-main")}>EASY</View> WORLD!</Text>*/}
