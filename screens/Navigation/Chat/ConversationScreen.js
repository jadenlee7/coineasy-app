...
const ConversationScreen = ({navigation, route}) => {
    ...
    //                     console.log(resultMessages.data[resultMessages.data.length -1].content);
            ...
            >
                <>
                    ...
                    <View style={{marginLeft: 13}}>
                        ...
                        <Text style={tailwind("text-secondary")}>{conversation.last_message}</Text>
                    </View>
                </>
            </TouchableHighlight>
        )
    ...
    const showConversation = async (client) => {
        ...
        if(indexConversation != -1){
            // console.log('ici');
            // console.log(conversations[indexConversation]);
    ...
    return(
        <View style={[tailwind('flex flex-1 flex-col'),{backgroundColor: 'white',}]}>
            ...
            <TouchableOpacity activeOpacity="0.8" style={[tailwind('absolute'), {elevation: 10, bottom: 15, right: 15} ]} onPress={() => {Haptics.selectionAsync();setShowSearchUser(true)}}>
                <Image
