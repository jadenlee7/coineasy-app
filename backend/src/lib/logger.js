...
export const LOGGER_REDACT_PATHS = Object.freeze([
  ...
  'stateHash',
  'proofHash',
  'linkedAccounts[*].subject',
  'linkedAccounts[*].email',
  'stableProviderIdentities[*].providerIdentityHash',
  'stableProviderIdentities[*].digest',
  'providerIdentities[*].providerIdentityHash',
  'providerIdentities[*].digest',
  'leaseToken',
  'authorizationCode',
  'accessToken',
  'refreshToken',
  ...
  'user.linkedAccounts[*].subject',
  'user.linkedAccounts[*].email',
  'user.stableProviderIdentities[*].providerIdentityHash',
  'user.stableProviderIdentities[*].digest',
  'accountDeletion.subjectHash',
  'accountDeletion.subjectHashKeyFingerprint',
  'accountDeletion.privyDidCiphertext',
  'accountDeletion.providerSubjectHash',
  'accountDeletion.providerIdentityHash',
  'accountDeletion.providerIdentities[*].providerIdentityHash',
  'accountDeletion.providerIdentities[*].digest',
  'accountDeletion.leaseToken',
  '*.email',
  '*.privyId',
  '*.privyDid',
  '*.walletAddress',
